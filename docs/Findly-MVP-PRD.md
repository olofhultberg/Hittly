# 📦 Hittly – MVP PRD Smartphone APP

## 1. Översikt

**Syfte:**  
Hittly-appen hjälper användare hålla ordning på saker som förvaras i förråd, vindar och källare.  
...
6. Skapa web app som kommer kunna "spegla" ditt konto i Hittly
